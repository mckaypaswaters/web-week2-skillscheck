...
let me = {
    firstName:'McKay',
    superHeroName:  'The Blue Wave',
    homeTown: 'Pleasant Grove',
    superPowers: ['Breathe underwater', 'Control water', 'Speak with undersea life'],
...
//////////////////Step 5////////////////////
//Create a function called 'setPowers' that takes in arr as a parameter. Loop over the arr param and run a function called createLi(), which will 
// take each item of the array as an agument. The createLi function is a function we created to set the data on the screen. It outside the scope of this project
...
// Loop over the object and change each keys value to 'redacted'. Outside of the loop but still in the redactInfo function, 
